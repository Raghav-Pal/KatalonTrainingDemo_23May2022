...
WebUI.click(findTestObject('Object Repository/WEB/Page_CURA Healthcare Service/td_25'))

WebUI.setText(findTestObject('Object Repository/WEB/Page_CURA Healthcare Service/textarea_Comment_comment'), 'demo comment')
