...
not_run: WebUI.click(findTestObject('Object Repository/WEB/Page_The Internet/li_Context Menu'))
...
not_run: WebUI.waitForAlert(4)

not_run: WebUI.verifyAlertPresent(4)
