...
WebUI.click(findTestObject('Object Repository/WEB/Page_CURA Healthcare Service/input_Demo account_form-control'))

WebUI.setText(findTestObject('Object Repository/WEB/Page_CURA Healthcare Service/input_Username_username'), 'John Doe')

WebUI.click(findTestObject('Object Repository/WEB/Page_CURA Healthcare Service/input_Demo account_form-control_1'))
...
WebUI.click(findTestObject('Object Repository/WEB/Page_CURA Healthcare Service/span_Visit Date (Required)_glyphicon glyphi_cada34'))

WebUI.click(findTestObject('Object Repository/WEB/Page_CURA Healthcare Service/td_31'))

WebUI.setText(findTestObject('Object Repository/WEB/Page_CURA Healthcare Service/textarea_Comment_comment'), 'abcd')

WebUI.click(findTestObject('Object Repository/WEB/Page_CURA Healthcare Service/button_Book Appointment'))

WebUI.verifyElementText(findTestObject('Object Repository/WEB/Page_CURA Healthcare Service/h2_Appointment Confirmation'), 'Appointment Confirmation')
